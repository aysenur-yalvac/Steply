...
const regexToReplace = /\s*\/\/ 2\. E-posta dogrulanmis ancak Ogretmen \(pending\) kontrolu[\s\S]*?(?=\s*\/\/ Auth sayfasinda)/;
...
const newContent = `
      ...
      // Ogrenci ise Ogretmen ve Admin paneline erisimi reddet
      ...
      // Istege bagli: Ogretmense ogrenci paneline erisimi yonlendir (suan icin sadece student->teacher kilit istendi)
`;
