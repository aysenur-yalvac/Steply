  ...
  return (
    <div className="min-h-screen w-full bg-[#f8fafc] p-6 sm:p-10 flex flex-col items-center justify-center">
      <div className="w-full  max-w-xl space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 dark:bg-slate-900 dark:border-slate-800 dark:text-slate-200 focus:dark:border-purple-500">
        ...
        <div className="bg-white dark:bg-[#0f172a] dark:bg-[#0f172a] dark:bg-slate-900/70 dark:backdrop-blur-lg dark:border dark:border-slate-800 dark:shadow-2xl dark:text-slate-100 dark:border-slate-800 shadow-xl text-slate-900 dark:text-slate-100 rounded-[2rem] p-8 sm:p-10 w-full relative z-10">
                ...
                {PRIORITIES.map(({ value, activeClass }) => (
                  <button
                    ...
                    className={`flex-1 py-2.5 rounded-xl text-sm font-bold border transition-all ${
                      priority === value
                        ? activeClass
                        : 'bg-white border-slate-200 text-slate-500 dark:bg-slate-800 dark:border dark:border-slate-700/80 dark:text-slate-200 dark:text-slate-300 dark:text-slate-400 hover:border-slate-300 hover:text-slate-700 dark:text-slate-300'
                    }`}
                  >
                    {value}
                  </button>
