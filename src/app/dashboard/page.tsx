        ...
        <div className="flex items-center gap-4">
          {profile?.role === 'student' && (
           <Link 
            ...
            className="group relative flex items-center justify-center gap-2 bg-dusty-rose hover:bg-rose-600 text-white font-bold px-7 py-3.5 rounded-full transition-all shadow-md hover:shadow-lg shrink-0 active:scale-95 border border-white/20 overflow-hidden"
          >
