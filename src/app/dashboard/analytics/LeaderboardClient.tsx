        ...
        return (
          ...
          >
            ...
            <div className="shrink-0 text-right min-w-[56px]">
              <p className={`text-sm font-extrabold ${isMe ? "text-violet-600" : rowStyle ? rowStyle.text : "text-slate-700"}`}>
    ...
    <div className="flex flex-col min-h-full bg-[#f8fafc]">
      ...
      <div className="flex-1 p-6 lg:p-8 flex flex-col gap-6">
        ...
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
          ...
          {/* Table header */}
          <div className="grid grid-cols-[40px_1fr_auto_56px] gap-4 px-5 py-2.5 bg-slate-50/60 border-b border-slate-100">
            ...
            <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest text-right">Puan</span>
          </div>
