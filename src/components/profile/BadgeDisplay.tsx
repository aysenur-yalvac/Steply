...
export const BADGE_CONFIG: Record<string, {
  ...
  streak_30:         { emoji: "⚡", label: "30-Day Streak",     desc: "Active 30 consecutive days",          color: "bg-amber-100 text-amber-700 border-amber-300"   },
  ...
  top_10_university: { emoji: "🎓", label: "Top 10 Uni",       desc: "Top 10 in your university",           color: "bg-emerald-100 text-emerald-700 border-emerald-300" },
  turkey_champion:   { emoji: "🏆", label: "TR Champion",      desc: "#1 in Türkiye",                       color: "bg-red-100 text-red-700 border-red-300"         },
};
