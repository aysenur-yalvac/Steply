...
export default function GlobalSearch() {
  ...
  return (
    <div className="relative flex items-center group w-full sm:w-64 transition-all">
      <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-slate-500 dark:text-slate-400 group-focus-within:text-indigo-500 transition-colors z-10">
