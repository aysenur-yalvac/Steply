      ...
      <div className="flex-1 min-w-0 h-full flex flex-col bg-white">
        ...
        {canAnnotate && (
          <div className="flex flex-wrap items-center gap-2 p-2 bg-white border-b border-slate-200 shrink-0">
            <button onClick={() => setTool('none')} className={`px-3 py-1.5 rounded-lg flex items-center gap-2 text-sm font-semibold ${tool === 'none' ? 'bg-indigo-100 text-indigo-700' : 'text-slate-500 hover:bg-slate-100'} dark:!bg-slate-800 dark:!text-slate-200 dark:!border dark:!border-slate-700/80`}>Seç/Oku</button>
            <button onClick={() => setTool('pen')} className={`px-3 py-1.5 rounded-lg flex items-center gap-2 text-sm font-semibold ${tool === 'pen' ? 'bg-indigo-100 text-indigo-700' : 'text-slate-500 hover:bg-slate-100'} dark:!bg-slate-800 dark:!text-slate-200 dark:!border dark:!border-slate-700/80`}><PenTool className="w-4 h-4" /> Çiz</button>
            <button onClick={() => setTool('rect')} className={`px-3 py-1.5 rounded-lg flex items-center gap-2 text-sm font-semibold ${tool === 'rect' ? 'bg-indigo-100 text-indigo-700' : 'text-slate-500 hover:bg-slate-100'} dark:!bg-slate-800 dark:!text-slate-200 dark:!border dark:!border-slate-700/80`}><Square className="w-4 h-4" /></button>
            <button onClick={() => setTool('circle')} className={`px-3 py-1.5 rounded-lg flex items-center gap-2 text-sm font-semibold ${tool === 'circle' ? 'bg-indigo-100 text-indigo-700' : 'text-slate-500 hover:bg-slate-100'} dark:!bg-slate-800 dark:!text-slate-200 dark:!border dark:!border-slate-700/80`}><CircleIcon className="w-4 h-4" /></button>
            <button onClick={() => setTool('line')} className={`px-3 py-1.5 rounded-lg flex items-center gap-2 text-sm font-semibold ${tool === 'line' ? 'bg-indigo-100 text-indigo-700' : 'text-slate-500 hover:bg-slate-100'} dark:!bg-slate-800 dark:!text-slate-200 dark:!border dark:!border-slate-700/80`}><Minus className="w-4 h-4" /></button>
            <button onClick={() => setTool('arrow')} className={`px-3 py-1.5 rounded-lg flex items-center gap-2 text-sm font-semibold ${tool === 'arrow' ? 'bg-indigo-100 text-indigo-700' : 'text-slate-500 hover:bg-slate-100'} dark:!bg-slate-800 dark:!text-slate-200 dark:!border dark:!border-slate-700/80`}><MoveRight className="w-4 h-4" /></button>
            <button onClick={() => setTool('eraser')} className={`px-3 py-1.5 rounded-lg flex items-center gap-2 text-sm font-semibold ${tool === 'eraser' ? 'bg-indigo-100 text-indigo-700' : 'text-slate-500 hover:bg-slate-100'} dark:!bg-slate-800 dark:!text-slate-200 dark:!border dark:!border-slate-700/80`}><Eraser className="w-4 h-4" /> Sil</button>
