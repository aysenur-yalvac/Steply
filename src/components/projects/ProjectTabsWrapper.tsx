        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all text-left font-semibold text-sm relative ${isActive ? 'bg-violet-600 text-white shadow-md' : 'bg-white text-slate-600 dark:text-slate-300 hover:bg-violet-50 hover:text-violet-700 border border-slate-100 hover:border-violet-200'}`}
            >
